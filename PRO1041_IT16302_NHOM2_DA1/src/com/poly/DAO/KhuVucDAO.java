...
public class KhuVucDAO extends CoffeShopSysDAO<KhuVuc, String> {
    ...
    String INSERT_SQL = "INSERT INTO KHUVUC (MaKV, TenKV, TienIch, DeleteKV) VALUES (?, ?, ?, ?)";
    String UPDATE_SQL = "UPDATE KHUVUC SET TenKV=?, TienIch=? WHERE MaKV=?";
    String DELETE_SQL = "UPDATE KHUVUC SET DeleteKV=1 WHERE MaKV=?";
    String SELECT_ALL_SQL = "SELECT * FROM KHUVUC WHERE DeleteKV=0";
    String SELECT_ALLNew_SQL = "SELECT * FROM KHUVUC";
    String SELECT_BY_ID_SQL = "SELECT * FROM KHUVUC WHERE MaKV=? AND DeleteKV=0";
    ...
    public List<KhuVuc> selectAllNew() {
