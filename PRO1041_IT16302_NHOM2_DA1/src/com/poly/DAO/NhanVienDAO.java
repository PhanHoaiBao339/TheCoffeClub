...
public class NhanVienDAO extends CoffeShopSysDAO<NhanVien, String> {
    ...
    String INSERT_SQL = "INSERT INTO NHANVIEN (MaNV, TenNV, Hinh, CMND, DiaChi, GioiTinh, Email, DienThoai, NgaySinh, NgayVaoLam, ViTri, DeleteNV) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    String DELETE_SQL = "UPDATE NHANVIEN SET DeleteNV=1 WHERE MaNV=?";
    String SELECT_ALL_SQL = "SELECT * FROM NHANVIEN WHERE DeleteNV=0";
    String SELECT_ALLNew_SQL = "SELECT * FROM NHANVIEN";
    String SELECT_BY_ID_SQL = "SELECT * FROM NHANVIEN WHERE MaNV=? AND DeleteNV=0";
    String SELECT_BY_KEYWORD_SQL = "SELECT * FROM NHANVIEN WHERE (MaNV LIKE ? OR TenNV Like ?) AND DeleteNV=0";
    ...
    public List<NhanVien> selectAllNew() {
        return this.selectBySql(SELECT_ALLNew_SQL);
    }
}
