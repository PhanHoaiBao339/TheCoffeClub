...
public class DangNhapJDialog extends javax.swing.JDialog {
    ...
    private void getOTP() {
        ...
        if (r.checkEmail(txtEmail)) {
            ...
            if (OTPTC) {
                new ThongBaoJDialog(null, true).alert(1, "Gửi OTP thành công! Vui lòng kiểm tra Email của bạn!");
                btnGetOTP.setEnabled(false);
            } else {
                new ThongBaoJDialog(null, true).alert(2, "Gửi OTP thất bại! Kiểm tra lại Email!" + knm);
                otp = 0;
                knm = "";
            }
        } else {
    ...
    private void initComponents() {
        ...
        lblMail.setText("Your email address");
