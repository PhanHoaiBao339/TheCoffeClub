...
public class MaQRcodeJDialog extends javax.swing.JDialog {
    ...
    private void sentEmail(String path){
        ...
        try {
            ...
            email.setMsg("Đây là mã QR của bạn, mã QR sử dụng để đăng nhập nhanh vào tài khoản, vì lí do bảo mật bạn vui lòng chia sẻ mã này cho bất kỳ ai! ");
            email.attach(attachment);
            email.send();
            txtThongBao.setText("Mã QR đã gửi đến Email của tài khoản được đăng ký và Lưu dưới dạng ảnh tại màn hình chính!");
