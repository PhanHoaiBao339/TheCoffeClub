...
public class NhanVienJDialog extends javax.swing.JDialog {
    ...
    private void init() {
        ...
        if (Auth.user != null) {
            ...
            setTitle("BÁN HÀNG - " + Auth.nameNV() + " - " + vt);
        }
    }
    ...
    private void deleteNV() {
        if (!Auth.isManager()) {
            ...
            if (Auth.user.getMaNV().equalsIgnoreCase(txtMaNV.getText())) {
                ...
                try {
                    daonv.delete(manv);
                    Account accx = daoac.selectByManv(manv);
                    if (accx != null) {
                        daoac.delete(accx.getUserName());
                    }
                    this.fillTableNV();
                    this.clearFormNV();
    ...
    private void xemTTCT() {
        ...
        for (int i = 0; i < tblNhanVien.getRowCount(); i++) {
            if (tblNhanVien.getValueAt(i, 1).toString().equals(nvc)) {
                rownv = i;
                this.editNVacc(nvc);
                this.updateStatusNV();
            }
    ...
    private String taoMaNV() {
        ...
        int i = 1;
        mnv = mn + "00" + i;
        List<NhanVien> list = daonv.selectAllNew();
        for (NhanVien nv : list) {
    ...
    private void initComponents() {
        ...
        lblAnhNhanVien.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                lblAnhNhanVienMousePressed(evt);
            }
        });
        ...
        txtTiemKiemCN.setEditable(false);
        ...
        txtTiemKiemCN.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                txtTiemKiemCNMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                txtTiemKiemCNMouseExited(evt);
            }
        });
        ...
        btnThemAnh.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/poly/Icons/UI_new_blue_x32.png"))); // NOI18N
        btnThemAnh.setText("Thêm Ảnh");
        btnThemAnh.setFocusable(false);
        btnThemAnh.setIconTextGap(6);
        btnThemAnh.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/com/poly/Icons/UI_new_blue2_x32.png"))); // NOI18N
                ...
                .addGroup(CapNhatJPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(CapNhatJPanelLayout.createSequentialGroup()
                        .addGroup(CapNhatJPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(CapNhatJPanelLayout.createSequentialGroup()
                                .addGap(19, 19, 19)
                                .addComponent(btnThemAnh, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(40, 40, 40)
                        .addGroup(CapNhatJPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(CapNhatJPanelLayout.createSequentialGroup()
    ...
    private void lblAnhNhanVienMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblAnhNhanVienMousePressed
        this.chonAnh();
    }//GEN-LAST:event_lblAnhNhanVienMousePressed
    ...
    private void txtTiemKiemCNMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtTiemKiemCNMouseEntered
        txtTiemKiemCN.setEditable(true);
    }//GEN-LAST:event_txtTiemKiemCNMouseEntered

    private void txtTiemKiemCNMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtTiemKiemCNMouseExited
        txtTiemKiemCN.setEditable(false);
    }//GEN-LAST:event_txtTiemKiemCNMouseExited
